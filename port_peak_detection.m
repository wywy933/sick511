...
%     grid on;
    ...
    xx = zeros(1,length(limited_dis_1));
    yy = zeros(1,length(limited_dis_1));
    for i = 1:length(limited_dis_1)
        xx(i) = limited_dis_1(i) * cos(limited_theta_1(i) + rotate_angle);
        yy(i) = limited_dis_1(i) * sin(limited_theta_1(i) + rotate_angle);
    end
...
%     subplot(1,2,2)
    ...
    for i = 1:size(BB)
        polar(limited_theta_1(BB(i,2)),limited_dis_1(BB(i,2)),'o');
    end
